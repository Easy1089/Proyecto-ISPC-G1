...
/* Ejercicio Nº3 - Arias Martin - Borrar el animal que ya no sea atendido desde hace mucho tiempo*/

/*consulta el historial en orden cronológico*/
SELECT * FROM historial
ORDER BY fecha;

/* elimina el animal que ya no es atendido utilizando la id del perro*/
DELETE FROM historial WHERE perro=4021;

/* se vuelve a consultar el historial para verificar el cambio */
SELECT * FROM historial
ORDER BY fecha;
